        ...
        <div className='bg-withdraw flex flex-col  sm:h-[1000px] md:h-[950px] relative'>
            ...
            <div>
                ...
                >
                    ...
                    <div>
                        <button onClick={() => handleWithdrawal()} className='bg-[rgb(164,29,35)] text-white px-2 py-1 rounded-lg shadow-md w-[64px]'>Yes</button>
                        <button onClick={() => setIsOpen(false)} className='bg-[rgb(164,29,35)] text-white px-2 py-1 rounded-lg shadow-md w-[64px] ml-2'>cancel</button>
                    </div>
                </ReactModal>
            </div>
            <div className="options flex bg-[rgb(164,29,35)] items-center text-center text-white text-lg py-2 px-1 font-normal">
...
{/*| After Deduction} | Rs.{(Number(wamount) - (Number(amountDetails.withdrawal_fee) * Number(wamount) / 100))}*/}
            ...
            <div className="part1 bg-white p-4 rounded-lg mx-3 mt-5">
                ...
                {/* <div className="balance flex justify-between text-gray-600 sm:text-md md:text-xl p-3">
                    <div className="wpwd w-2/3">OTP: <span className='text-sm bg-[rgb(164,29,35)] text-white px-3 py-1 hover:cursor-pointer rounded-full' onClick={() => handleOTPSend(String(Math.floor(100000 + Math.random() * 900000)))}>Send OTP</span></div>
