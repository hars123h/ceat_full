  ...
  if (loading) {
    return (
      ...
      <div className="flex flex-col bg-white gap-1">
        ...
        <div className='flex shadow-myShadow flex-row w-full justify-between px-4 text-white items-center h-[104px] rounded-lg bg-[rgb(164,29,35)]'>
      ...
      <div onClick={() => setLogout_popup(true)} className="flex flex-row justify-center text-xl
        w-[80%] mx-auto py-1 mt-10 text-center rounded-md bg-[rgb(164,29,35)] text-white font-semibold">
        <div>Sign out</div>
      </div>
