  ...
  if (loading || userDetails === null) {
    return (
      <div className='bg-white'>
        {/* [#2e9afe] */}
        <div className="top flex items-center my-auto text-center h-[44px] p-1 bg-[rgb(164,29,35)] text-white text-md font-medium">
        ...
        <div className="flex flex-row justify-between items-center p-2 border-b border-gray-300" >
          ...
          <div>
            <button className="bg-[rgb(164,29,35)] text-white text-xs px-2 rounded-full py-[3px] flex items-center gap-1">
