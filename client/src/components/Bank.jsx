    ...
    return (
        <div className='bg-white h-screen  sm:h-[700px] md:h-[950px] relative'>
           {toasterShow?<div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
            ...
            <div className="options text-center flex bg-[rgb(164,29,35)] p-3 border-b border-white text-white text-lg items-center font-medium">
            ...
            <div className='mb-[1000px] mx-4'>
                <button onClick={handleSubmit} className='bg-[rgb(164,29,35)] text-white text-lg mt-5 mb-20 rounded-sm shadow-md block w-full py-2 shadow-red-200'>Confirm</button>
            </div>
        </div>
    )
}
