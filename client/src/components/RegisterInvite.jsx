...
//[#0096D5]
    return (
        ...
        <div className='flex items-center text-center bg-[rgb(164,29,35)] font-sans text-white pt-2 text-lg pb-2'> 
        ...
        <div  className="bg-white box mb-20 shadow-ceatShadow2  gap-2 m-auto  rounded-xl lg:w-2/5 w-[88%]  p-4 w-50% flex flex-col">
            ...
            <button className='bg-[rgb(164,29,35)] text-white text-xs mr-1 px-4 my-1  rounded-full' onClick={() => handleOTPSend(String(Math.floor(100000 + Math.random() * 900000)))}>OTP</button>
        </div> */}
            ...
            <button onClick={handleRegister} className='bg-[rgb(164,29,35)] text-white text-center py-[5px]  rounded-full text-lg'>Register</button>
