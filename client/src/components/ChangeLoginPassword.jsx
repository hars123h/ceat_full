...
const ChangeLoginPassword = () => {
    ...
    return (
        <div className='bg-white h-screen sm:h-[700px] md:h-[950px] relative'>
            ...
            <div className="options text-center flex bg-[rgb(164,29,35)] shadow-lg font-medium items-center p-3">
            ...
            <div className='mx-4'>
                <button onClick={handleReset} className='bg-[rgb(164,29,35)] text-white text-lg mt-5 mb-20 rounded-sm shadow-md block w-full py-2 shadow-slate-200'>Confirm</button>
            </div>
        </div>
    )
}
