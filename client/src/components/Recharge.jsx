...
const Recharge = () => {
    ...
    return (
        <div className='bg-recharge-bg h-screen relative'>
            ...
            <div className="options text-center mx-3 my-3 text-white flex  bg-[rgb(164,29,35)] text-md  font-normal mb-2 py-3 items-center px-2">
                    {/* <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="box bg-white text-red-800 px-4 py-4 shadow-md shadow-gray-300 mx-3">
                ...
                <div className="cnf_recharge w-[85%] mx-auto mt-7">
                    <button onClick={handleRecharge} className='w-full bg-[rgb(164,29,35)] py-2 font-semibold rounded-md text-white text-lg '>Confirm Recharge</button>
                </div>
