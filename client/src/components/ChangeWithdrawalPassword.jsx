...
const ChangeWithdrawalPassword = () => {
    ...
    return (
        <div className='bg-white h-screen sm:h-[700px] md:h-[950px] relative'>
            ...
            <div className='mx-4'>
                {/* [#7899de] */}
                <button onClick={handleReset} className='bg-[rgb(164,29,35)] text-white text-lg mt-5 mb-20 rounded-sm shadow-lg block w-full py-2 shadow-slate-100'>Confirm</button>
            </div>
        </div>
    )
}
